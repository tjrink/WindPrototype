...
func generate_tranches():
	...
	var base_wind = randf_range(-20, 20) #Sets a base wind value
...
func generate_horizontal_tranches(base_wind):
	...
	while idx_horizontal < MAX_Y:
		...
		base_wind+=randf_range(-3, 3)
		WIND_TRANCHES_HORIZONTAL.append([tranche_start, base_wind])
...
func generate_vertical_tranches(base_wind):
	...
	while idx_vertical < MAX_X:
		...
		base_wind+=randf_range(-3, 3)
		WIND_TRANCHES_VERTICAL.append([tranche_start, base_wind])
